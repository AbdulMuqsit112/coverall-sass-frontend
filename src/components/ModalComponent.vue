<template>
  <div class="fixed inset-0 flex items-center justify-center bg-opacity-80 backdrop-filter backdrop-blur-md">
    <div class="modal bg-white shadow-lg rounded-lg w-[40rem]">
      <div class="modal-content">
        <h2 class="modal-title text-2xl text-center font-bold py-4 border-b border-gray-200">Modal Title</h2>
        ...
        <div class="modal-footer flex justify-between p-4 border-t border-gray-200">
          ...
          <button @click="submitForm" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">Submit</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  props: {
    ...
    // Change the radioButtons prop type to Array
    radioButtons: {
      type: Array,
      default: () => []
    },
